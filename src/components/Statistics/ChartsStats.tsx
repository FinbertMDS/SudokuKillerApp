...
import { convertLogsToStats, convertToPieData, convertToStackedData } from '../../utils/statsUtil';
...
const ChartsStats = ({ logs }: ChartsStatsProps) => {
  ...
  const stackedData = useMemo(() => convertToStackedData(logs, mode), [logs, mode]);
  ...
  return (
    <ScrollView style={{ backgroundColor: theme.background }}>
      ...
      <GameStackedBarChart stackedData={stackedData} chartConfig={chartConfig} />
    </ScrollView>
  );
};
