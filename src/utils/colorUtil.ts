...
export function getLevelColor(level: Level, scheme: ColorSchemeName = 'light'): string {
  return levelColors[level][scheme!];
}

export function getLevelColorsBySchema(scheme: ColorSchemeName = 'light'): string[] {
